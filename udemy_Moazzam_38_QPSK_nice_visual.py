...
# Title: udemy Moazzam 38 QPSK nice visualisation
# Author: yabool2001
# Copyright: mzemlo.pl@gmail.com
# Description: 38. QPSK Signal Generation in GNU Radio nice visualisation
...
class udemy_Moazzam_38_QPSK_nice_visual(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "udemy Moazzam 38 QPSK nice visualisation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("udemy Moazzam 38 QPSK nice visualisation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "udemy_Moazzam_38_QPSK_nice_visual")
...
def main(top_block_cls=udemy_Moazzam_38_QPSK_nice_visual, options=None):
