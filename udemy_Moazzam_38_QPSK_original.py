...
# Title: udemy Moazzam 38 QPSK original
# Author: yabool2001
# Copyright: mzemlo.pl@gmail.com
# Description: 38. QPSK Signal Generation in GNU Radio-2
...
class udemy_Moazzam_38_QPSK_original(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "udemy Moazzam 38 QPSK original", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("udemy Moazzam 38 QPSK original")
        ...
        self.settings = Qt.QSettings("GNU Radio", "udemy_Moazzam_38_QPSK_original")
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f(( 0 , 1 , 1 , 0 ), True, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_f(( 0 , 0 , 1 , 1 ), True, 1, [])
        ...
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.blocks_vector_source_x_0_0, 0), (self.blocks_multiply_const_vxx_0, 0))
...
def main(top_block_cls=udemy_Moazzam_38_QPSK_original, options=None):
