...
class lesson08a_pluto2pluto(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lesson08a_plutopluto", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lesson08a_plutopluto")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lesson08a_pluto2pluto")
...
def main(top_block_cls=lesson08a_pluto2pluto, options=None):
