...
class yabool2001_packet_tx_v1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "packet tx v1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("packet tx v1")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "yabool2001_packet_tx_v1")
...
def main(top_block_cls=yabool2001_packet_tx_v1, options=None):
