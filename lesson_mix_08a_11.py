...
class lesson_mix_08a_11(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lesson_mix_08a_11", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lesson_mix_08a_11")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lesson_mix_08a_11")
        ...
        self._tx_attenuation_range = qtgui.Range(10, 70, 1, 30, 200)
        ...
        self._samp_rate_win = qtgui.RangeWidget(self._samp_rate_range, self.set_samp_rate, "Sampling rate", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._samp_rate_win)
        self._fc_range = qtgui.Range(868e6, 870e6, 1000000, 869e6, 200)
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('usb:2.10.5' if 'usb:2.10.5' else iio.get_pluto_uri(), [True, True], 32768)
        self.iio_pluto_source_0.set_len_tag_key('packet_len')
        self.iio_pluto_source_0.set_frequency(int ( fc ))
        ...
        self.iio_pluto_sink_0 = iio.fmcomms2_sink_fc32('usb:2.10.5' if 'usb:2.10.5' else iio.get_pluto_uri(), [True, True], 32768, False)
        self.iio_pluto_sink_0.set_len_tag_key('')
        self.iio_pluto_sink_0.set_bandwidth(20000000)
        self.iio_pluto_sink_0.set_frequency(int ( fc ))
        ...
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_gr_complex*1, int ( sps ))
        self.blocks_keep_one_in_n_0 = blocks.keep_one_in_n(gr.sizeof_float*1, int ( sps ))
        ...
        self.connect((self.blocks_repeat_0, 0), (self.iio_pluto_sink_0, 0))
        self.connect((self.blocks_repeat_0, 0), (self.qtgui_const_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(int ( self.fc ), self.samp_rate)
    ...
    def set_fc(self, fc):
        self.fc = fc
        self.iio_pluto_sink_0.set_frequency(int ( self.fc ))
        self.iio_pluto_source_0.set_frequency(int ( self.fc ))
        self.qtgui_freq_sink_x_0.set_frequency_range(int ( self.fc ), self.samp_rate)




def main(top_block_cls=lesson_mix_08a_11, options=None):
