...
# Title: QPSK constellation generation
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "QPSK constellation generation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK constellation generation")
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f((0, 0, 1, 1), True, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_f((0, 1, 1, 0), True, 1, [])
