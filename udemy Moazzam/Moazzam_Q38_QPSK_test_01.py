...
import Moazzam_Q38_QPSK_test_01_epy_block_0 as epy_block_0  # embedded python block
import Moazzam_Q38_QPSK_test_01_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class Moazzam_Q38_QPSK_test_01(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Moazzam 38. QPSK test 01", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Moazzam 38. QPSK test 01")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Moazzam_Q38_QPSK_test_01")
        ...
        self.pdu_random_pdu_0 = pdu.random_pdu(1, 1, 0x03, 1)
...
def main(top_block_cls=Moazzam_Q38_QPSK_test_01, options=None):
