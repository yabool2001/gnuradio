...
# Title: bpsk packet transfer test 01
# Author: yabool2001
# Copyright: mzemlo.pl@gmail.com
# Description: bpsk packet transfer test 01
...
class yabool2001_bpsk_packet_transfer_test_01(gr.top_block, Qt.QWidget):

    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0), header_format=0):
        gr.top_block.__init__(self, "bpsk packet transfer test 01", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("bpsk packet transfer test 01")
        ...
        self.settings = Qt.QSettings("GNU Radio", "yabool2001_bpsk_packet_transfer_test_01")
        ...
        self.variable_adaptive_algorithm = variable_adaptive_algorithm = digital.adaptive_algorithm_cma( variable_constellation, .0001, 2).base()
        ...
        self.digital_linear_equalizer_0 = digital.linear_equalizer(15, 1, variable_adaptive_algorithm, 1, [], '')
        ...
        self.digital_constellation_modulator_0_0 = digital.generic_mod(
            ...
            log=False,
            truncate=False)
        self.digital_constellation_decoder_cb_1_0 = digital.constellation_decoder_cb(variable_constellation)
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0, 0), (self.digital_correlate_access_code_xx_ts_0, 0))
    ...
    def set_variable_constellation(self, variable_constellation):
        ...
        self.digital_constellation_decoder_cb_1_0.set_constellation(self.variable_constellation)
...
def main(top_block_cls=yabool2001_bpsk_packet_transfer_test_01, options=None):
    if options is None:
