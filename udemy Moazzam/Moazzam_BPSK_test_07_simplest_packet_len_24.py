...
# Title: Moazzam BPSK test 07 simplest packet len 24
# Author: yabool2001
...
class Moazzam_BPSK_test_07_simplest_packet_len_24(gr.top_block, Qt.QWidget):

    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        gr.top_block.__init__(self, "Moazzam BPSK test 07 simplest packet len 24", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Moazzam BPSK test 07 simplest packet len 24")
        ...
        self.pdu_random_pdu_0 = pdu.random_pdu(24, 26, 0xFF, 2)
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("Litwo ojczyzno moja..."), 3000)
        ...
        self.msg_connect((self.pdu_random_pdu_0, 'pdus'), (self.blocks_message_debug_0, 'print_pdu'))
...
def main(top_block_cls=Moazzam_BPSK_test_07_simplest_packet_len_24, options=None):
    if options is None:
