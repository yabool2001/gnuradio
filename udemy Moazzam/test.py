...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/moazzam/Downloads/test.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/moazzam/Downloads/out.txt', False)
