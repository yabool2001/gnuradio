...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.blocks_file_sink_0_0_0_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\mzeml\\gnuradio\\udemy Moazzam\\tagged_stream.txt', False)
        ...
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.blocks_file_sink_0_0_0_0, 0))
