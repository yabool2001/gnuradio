...
# Title: Wiki Tuto GNU Radio Low Pass Filter Example
# Author: yabool2001
# Copyright: maciej.zemlo@gmail.pl
# Description: https://wiki.gnuradio.org/index.php?title=Low_Pass_Filter_Example
...
class tuto_wikignuradio_lpf(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Wiki Tuto GNU Radio Low Pass Filter Example", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Wiki Tuto GNU Radio Low Pass Filter Example")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tuto_wikignuradio_lpf")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self._f_range = qtgui.Range(-samp_rate/2, samp_rate/2, 1, 1000, 200)
...
def main(top_block_cls=tuto_wikignuradio_lpf, options=None):
