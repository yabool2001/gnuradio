...
class Protocol_Formatter_tuto_01(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.epy_block_1_0_0 = epy_block_1_0_0.byte_logger(samp_rate=samp_rate, filename="01_byte_tx_bpsk_mod_log.csv")
        ...
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_char*1, '05_byte_rx_bpsk_mod_log.csv', False)
