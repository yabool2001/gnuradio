...
class bpsk_01(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "bpsk_01", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("bpsk_01")
        ...
        self.qtgui_number_sink_0.set_title('input_bits')
        ...
        self._f_options = [0, 1000, -2000]
        # Create the labels list
        self._f_labels = ['f: 0', 'f: 1 000', 'f: -2 000']
        # Create the combo box
        self._f_tool_bar = Qt.QToolBar(self)
        self._f_tool_bar.addWidget(Qt.QLabel("'f'" + ": "))
        self._f_combo_box = Qt.QComboBox()
        self._f_tool_bar.addWidget(self._f_combo_box)
        for _label in self._f_labels: self._f_combo_box.addItem(_label)
        self._f_callback = lambda i: Qt.QMetaObject.invokeMethod(self._f_combo_box, "setCurrentIndex", Qt.Q_ARG("int", self._f_options.index(i)))
        self._f_callback(self.f)
        self._f_combo_box.currentIndexChanged.connect(
            lambda i: self.set_f(self._f_options[i]))
        # Create the radio buttons
        self.top_layout.addWidget(self._f_tool_bar)
        ...
        self.connect((self.analog_random_uniform_source_x_1, 0), (self.blocks_throttle2_0, 0))
        ...
        self.connect((self.blocks_uchar_to_float_0, 0), (self.qtgui_number_sink_0, 0))
