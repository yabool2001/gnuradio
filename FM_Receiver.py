...
class FM_Receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._volume_range = qtgui.Range(0, 10, 0.25, 1, 200)
        ...
        self._frec_range = qtgui.Range(105600000, 108000000, 100000, 105600000, 200)
        self._frec_win = qtgui.RangeWidget(self._frec_range, self.set_frec, "Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._frec_win)
        self._squelch_range = qtgui.Range(-100, 0, 1, -50, 200)
        self._squelch_win = qtgui.RangeWidget(self._squelch_range, self.set_squelch, "Squelch Level", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._squelch_win)
        self._rf_gain_range = qtgui.Range(0, 100, 1, 50, 200)
        ...
        self.iio_pluto_source_0.set_frequency(frec)
    ...
    def set_frec(self, frec):
        self.frec = frec
        self.iio_pluto_source_0.set_frequency(self.frec)
