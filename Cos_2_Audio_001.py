...
class Cos_2_Audio_001(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Cos_2_Audio_001", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Cos_2_Audio_001")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Cos_2_Audio_001")
        ...
        self._tx_attenuation_range = qtgui.Range(0, 100, 1, 40, 200)
        ...
        labels = ['Tx Time Re', 'Tx Time Im', 'Signal 3', 'Signal 4', 'Signal 5',
...
def main(top_block_cls=Cos_2_Audio_001, options=None):
