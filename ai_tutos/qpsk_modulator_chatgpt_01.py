...
# Title: ChatGPT QPSK Modulator 01
# Author: yabool2001
# Copyright: mzemlo.pl@gmail.com
# Description: QPSK Modulator example 01
...
class qpsk_modulator_chatgpt_01(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ChatGPT QPSK Modulator 01", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ChatGPT QPSK Modulator 01")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_modulator_chatgpt_01")
...
def main(top_block_cls=qpsk_modulator_chatgpt_01, options=None):
