...
# Title: dsp_tuto_001_bandpass_sampling
# Author: mzemlo.pl@gmail.com
# Copyright: Maciej Zemło
...
class dsp_tuto_001_bandpass_sampling(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "dsp_tuto_001_bandpass_sampling", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("dsp_tuto_001_bandpass_sampling")
        ...
        self.samp_rate = samp_rate = (fc-B)/m
        self.f = f = 3.5e9
        ...
        self._tx_attenuation_range = qtgui.Range(10, 100, 1, 40, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, 20e6, 1, 0, 0)
    ...
    def set_m(self, m):
        self.m = m
        self.set_samp_rate((self.fc-self.B)/self.m)
    ...
    def set_fc(self, fc):
        self.fc = fc
        self.set_samp_rate((self.fc-self.B)/self.m)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, (int(4*self.fc)))
