...
import Stream_CRC32_sb_01_epy_block_0_0 as epy_block_0_0  # embedded python block
import Stream_CRC32_sb_01_epy_block_1_0_0_0 as epy_block_1_0_0_0  # embedded python block
import Stream_CRC32_sb_01_epy_block_1_0_0_0_0 as epy_block_1_0_0_0_0  # embedded python block
import Stream_CRC32_sb_01_epy_block_1_0_0_0_1 as epy_block_1_0_0_0_1  # embedded python block
import sip
import threading



class Stream_CRC32_sb_01(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Stream CRC32 sandbox 01", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Stream CRC32 sandbox 01")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Stream_CRC32_sb_01")
        ...
        self.epy_block_0_0 = epy_block_0_0.complex_sps_file_sink(samp_rate=samp_rate, sps=sps, filename="03_complex_tx_bpsk_mod_log.csv")
...
def main(top_block_cls=Stream_CRC32_sb_01, options=None):
