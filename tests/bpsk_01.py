...
class bpsk_01(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BPSK 01", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK 01")
        ...
        self.settings = Qt.QSettings("GNU Radio", "bpsk_01")
        ...
        self.qtgui_number_sink_1_0.set_title("output bits")
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_1_0_win, 0, 2, 1, 1)
        for r in range(0, 1):
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_1_win, 0, 1, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_win, 1, 0, 1, 3)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
            1024, #size
            'output constellation sink', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_c((1+0j, -1+0j, 1+0j), True, 1, [])
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_float_0, 0), (self.qtgui_number_sink_1, 0))
        self.connect((self.blocks_complex_to_float_0, 1), (self.qtgui_number_sink_1_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.iio_pluto_sink_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.qtgui_const_sink_x_0_0, 0))
...
def main(top_block_cls=bpsk_01, options=None):
