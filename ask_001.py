...
class ask_001(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ASK 001", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ASK 001")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ask_001")
        ...
        self.fc = fc = 3.5e9
        self.fbb = fbb = 71000000
        self.co = co = digital.constellation_qpsk().base()
        self.co.set_npwr(1.0)

        ##################################################
        # Blocks
        ##################################################

        self._samp_rate_range = qtgui.Range(65105, 61440000, 1000, 10000000, 200)
        ...
        self._fc_range = qtgui.Range(70e6, 6e9, 1e6, 3.5e9, 200)
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "'fc'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._fbb_range = qtgui.Range(70e6, 6e9, 1e6, 71000000, 200)
        self._fbb_win = qtgui.RangeWidget(self._fbb_range, self.set_fbb, "baseband freq", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fbb_win)
        self.qtgui_time_sink_x_0_2 = qtgui.time_sink_f(
            1024, #size
            int ( samp_rate ), #samp_rate
            'Input Cosine Float', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_number_sink_1.set_title('output bits')
        ...
        for i in range(1):
            self.qtgui_number_sink_1.set_min(i, -2)
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('usb:2.1.5' if 'usb:2.1.5' else iio.get_pluto_uri(), [True, True], 32768)
        ...
        self.iio_pluto_sink_0 = iio.fmcomms2_sink_fc32('usb:2.1.5' if 'usb:2.1.5' else iio.get_pluto_uri(), [True, True], 32768, False)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'C:\\Users\\mzeml\\gnuradio\\log\\bpsk_003.log', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_real_0_0 = blocks.complex_to_real(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(int ( samp_rate ), analog.GR_COS_WAVE, int ( fbb ), 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.qtgui_time_sink_x_0_2, 0))
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.blocks_threshold_ff_0, 0))
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.iio_pluto_sink_0, 0))
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.qtgui_time_sink_x_0_1, 0))
        ...
        self.connect((self.iio_pluto_source_0, 0), (self.blocks_complex_to_real_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_0.set_samp_rate(int ( self.samp_rate ))
        self.qtgui_time_sink_x_0_0.set_samp_rate(int ( self.samp_rate ))
        self.qtgui_time_sink_x_0_1.set_samp_rate(int ( self.samp_rate ))
        self.qtgui_time_sink_x_0_2.set_samp_rate(int ( self.samp_rate ))
    ...
    def set_fbb(self, fbb):
        self.fbb = fbb
        self.analog_sig_source_x_0.set_frequency(int ( self.fbb ))
...
def main(top_block_cls=ask_001, options=None):
