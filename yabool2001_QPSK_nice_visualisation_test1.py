...
# Title: QPSK nice visualisation test1
# Author: yabool2001
# Copyright: mzemlo.pl@gmail.com
# Description: QPSK test1
...
class yabool2001_QPSK_nice_visualisation_test1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK nice visualisation test1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK nice visualisation test1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "yabool2001_QPSK_nice_visualisation_test1")
...
def main(top_block_cls=yabool2001_QPSK_nice_visualisation_test1, options=None):
