...
class yabool2001_QPSK_mod_nice_visual_w_Pluto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_constellation_modulator_0 = digital.generic_mod(
            ...
            log=False,
            truncate=False)
        self.blocks_vector_source_x_0_1 = blocks.vector_source_b([0,1], True, 1, [])
        ...
        self.connect((self.iio_pluto_source_0, 0), (self.qtgui_eye_sink_x_0_0, 0))
    ...
    def set_samp_rate_Pluto(self, samp_rate_Pluto):
        ...
        self.qtgui_eye_sink_x_0_0.set_samp_rate(self.samp_rate_Pluto)
