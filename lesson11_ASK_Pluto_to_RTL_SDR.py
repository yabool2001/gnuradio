...
# Title: lesson11_ASK_Pluto_to_RTL_SDR
# Author: jason
...
class lesson11_ASK_Pluto_to_RTL_SDR(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lesson11_ASK_Pluto_to_RTL_SDR", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lesson11_ASK_Pluto_to_RTL_SDR")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lesson11_ASK_Pluto_to_RTL_SDR")
        ...
        self._tx_attenuation_range = qtgui.Range(0, 89, 1, 40, 200)
...
def main(top_block_cls=lesson11_ASK_Pluto_to_RTL_SDR, options=None):
