...
import QPSK_test_04_epy_block_1 as epy_block_1  # embedded python block
...
class QPSK_test_04(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_1 = epy_block_1.byte_logger(samp_rate=samp_rate, filename="byte_tx_qpsk_mod_log.csv")
        ...
        self.blocks_repack_bits_bb_1 = blocks.repack_bits_bb(2, 8, '', False, gr.GR_LSB_FIRST)
