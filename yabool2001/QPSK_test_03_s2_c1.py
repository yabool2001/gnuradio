...
# Title: QPSK test 03 scenario 2 candidat 1
# Author: yabool2001
...
import QPSK_test_03_s2_c1_epy_block_0_0 as epy_block_0_0  # embedded python block
import QPSK_test_03_s2_c1_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class QPSK_test_03_s2_c1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK test 03 scenario 2 candidat 1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK test 03 scenario 2 candidat 1")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QPSK_test_03_s2_c1")
        ...
        self.epy_block_1 = epy_block_1.byte_logger(samp_rate=samp_rate, filename="byte_qpsk_mod_s2_c1_log.csv")
        self.epy_block_0_0 = epy_block_0_0.complex_sps_file_sink(samp_rate=samp_rate, sps=sps, filename="complex_qpsk_mod_s2_c1_log.csv")
...
def main(top_block_cls=QPSK_test_03_s2_c1, options=None):
