...
import QPSK_test_01_epy_block_0_0 as epy_block_0_0  # embedded python block
import QPSK_test_01_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class QPSK_test_01(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QPSK_test_01")
...
def main(top_block_cls=QPSK_test_01, options=None):
