...
import BPSK_test_02_epy_block_1_0 as epy_block_1_0  # embedded python block
import sip
import threading



class BPSK_test_02(gr.top_block, Qt.QWidget):

    def __init__(self, header_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        gr.top_block.__init__(self, "BPSK test 02", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK test 02")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BPSK_test_02")
        ...
        self.pluto_context_usb = pluto_context_usb = "usb:"
        self.pluto_context_uri = pluto_context_uri = "ip:192.168.2.1"
        self.f_o = f_o = 820000000
        self.const_obj = const_obj = digital.constellation_bpsk().base()
        self.const_obj.set_npwr(1)
        self.bdw = bdw = 20000000
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32(pluto_context_usb if pluto_context_usb else iio.get_pluto_uri(), [True, True], 32768)
        ...
        self.iio_pluto_sink_0 = iio.fmcomms2_sink_fc32(pluto_context_usb if pluto_context_usb else iio.get_pluto_uri(), [True, True], 32768, False)
        ...
        self.epy_block_1_0 = epy_block_1_0.byte_logger(samp_rate=samp_rate, filename="07_byte_rx_log.csv")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, "05_byte_rx_log.bin", False)
        ...
        self.connect((self.digital_constellation_decoder_cb_1_0, 0), (self.blocks_pack_k_bits_bb_0_0, 0))
    ...
    def get_pluto_context_usb(self):
        return self.pluto_context_usb

    def set_pluto_context_usb(self, pluto_context_usb):
        self.pluto_context_usb = pluto_context_usb
...
def main(top_block_cls=BPSK_test_02, options=None):
    if options is None:
