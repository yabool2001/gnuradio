...
class BPSK_test_02_5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BPSK test 02.5", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK test 02.5")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BPSK_test_02_5")
...
def main(top_block_cls=BPSK_test_02_5, options=None):
