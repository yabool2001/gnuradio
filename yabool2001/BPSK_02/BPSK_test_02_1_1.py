...
class BPSK_test_02_1_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._nop_range = qtgui.Range(0, 1024, 1, 16, 200)
        self._nop_win = qtgui.RangeWidget(self._nop_range, self.set_nop, "nop", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._nop_win)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.digital_constellation_modulator_0_0, 0))
        self.connect((self.digital_constellation_modulator_0_0, 0), (self.iio_pluto_sink_0, 0))
        self.connect((self.digital_constellation_modulator_0_0, 0), (self.qtgui_time_sink_x_0_0, 0))
