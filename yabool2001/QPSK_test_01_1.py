...
import QPSK_test_01_1_epy_block_0_0 as epy_block_0_0  # embedded python block
import QPSK_test_01_1_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class QPSK_test_01_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK test 01-1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK test 01-1")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QPSK_test_01_1")
        ...
        self.epy_block_0_0 = epy_block_0_0.complex_sps_file_sink(samp_rate=samp_rate, sps=sps, filename="complex_grc-mod_log.csv")
...
def main(top_block_cls=QPSK_test_01_1, options=None):
