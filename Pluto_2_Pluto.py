...
# Description: https://www.youtube.com/watch?v=GIdATdJi8jA
...
class Pluto_2_Pluto(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Pluto_2_Pluto", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Pluto_2_Pluto")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Pluto_2_Pluto")
        ...
        self._tx_attenuation_range = qtgui.Range(0, 100, 1, 10, 200)
        ...
        self._tone_f_range = qtgui.Range(-100000, 100000, 10000, 50000, 200)
        ...
        self._rx_gain_range = qtgui.Range(0, 70, 1, 64, 200)
        ...
        self.iio_pluto_source_0.set_frequency(int(f))
        ...
        self.iio_pluto_sink_0.set_frequency(int(f))
        self.iio_pluto_sink_0.set_samplerate(int(samp_rate))
        self.iio_pluto_sink_0.set_attenuation(0, tx_attenuation)
        self.iio_pluto_sink_0.set_filter_params('Auto', '', 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, tone_f, 1, 0, 0)
    ...
    def set_tone_f(self, tone_f):
        self.tone_f = tone_f
        self.analog_sig_source_x_0.set_frequency(self.tone_f)
    ...
    def set_f(self, f):
        self.f = f
        self.iio_pluto_sink_0.set_frequency(int(self.f))
        self.iio_pluto_source_0.set_frequency(int(self.f))




def main(top_block_cls=Pluto_2_Pluto, options=None):
