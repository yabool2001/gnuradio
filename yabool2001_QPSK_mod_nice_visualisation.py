...
# Title: QPSK modulation nice visualisation
# Author: yabool2001
# Copyright: mzemlo.pl@gmail.com
# Description: QPSK modulation nice visualisation
...
class yabool2001_QPSK_mod_nice_visualisation(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK modulation nice visualisation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK modulation nice visualisation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "yabool2001_QPSK_mod_nice_visualisation")
...
def main(top_block_cls=yabool2001_QPSK_mod_nice_visualisation, options=None):
